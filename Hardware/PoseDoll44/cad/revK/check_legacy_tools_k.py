...
def main():
 ...
 h.save(ROOT/'verification/revK_tool_access.json',dict(scope='Neutral staged geometry, 2 mm M2 driver shaft / 3 mm M3 shaft; no grip, torque or insertion sweep test',checks=results))
