...
def main():
    ...
    h.save(R/'verification/revK_new_tool_access.json',dict(scope='Bench subassembly before installation into outer shoulder yoke. Straight tool/insertion envelopes only, no hand grip, torque or flexible cable routing.',checks=checks))
