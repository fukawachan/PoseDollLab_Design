...
for name in ('quinn','manny'):
 ...
 candidates=[]
 for owner,origin,zs in [('chest',C,(75,90)),('pelvis',P,(-15,))]:
  for x in (-85,-70,-55,45,60,75):
   for y in (-46,0,46):
 ...
 shapes={q['id']:cube((18,44,94),q['xyz']) for q in candidates}
 for label,pose in cases.items():
  ...
  out[name]=candidates;h.save(ROOT/'verification/revM_electronics_pod_space.json',out)
